Best solution is: 
- delete the user/account (the mailbox will also be deleted) 
- create a new Shared Mailbox 
- Merge the deleted mailbox with the new one: 
...
#From <https://community.spiceworks.com/topic/1955341-office-365-convert-to-shared-mailbox-but-then-delete-user>
